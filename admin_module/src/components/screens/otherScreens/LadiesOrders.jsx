...
import "./otherCss/LadiesOrders.css";
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        const ladiesQuery = query(
          ordersCollection,
          where("category", "==", "ladies")
        );
        const ordersSnapshot = await getDocs(ladiesQuery);
      ...
      <div className="orders-container">
        {loading ? (
          ...
          <div className="no-orders-container">
            <p className="no-orders">No Ladies Orders Available!</p>
          </div>
        )}
      </div>
