...
app.post('/notifications.php', (req, res) => {
  const {name, adress, cell, product} = req.body;

  const mailOptions = {
    from: 'zabideen639@gmail.com', // Replace with your Gmail email
    to: 'muhammadzainulabideen292@gmail.com', // Replace with the admin's email
